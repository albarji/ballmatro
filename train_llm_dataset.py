...
from gpt.gpt import hf_stf_ballmatro_dataset
from datasets import load_dataset


def main(dataset: str, model: str, output: str = None, **training_kwargs):
    ...
    hf_stf_ballmatro_dataset(ds["train"], model, output, **training_kwargs)
...
if __name__ == "__main__":
    ...
    main(args.dataset, args.model, args.output, per_device_train_batch_size=args.per_device_train_batch_size)
